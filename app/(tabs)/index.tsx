  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-950">
      <ScrollView contentContainerClassName="p-5 pb-12 gap-5">
        {/* Welcome Card */}
        <View className="bg-indigo-600 p-6 rounded-3xl shadow-xl shadow-indigo-600/20">
        ...
        <View className="bg-slate-900 border border-slate-800 p-5 rounded-2xl gap-4">
          ...
          <View className="gap-3">
            <Link href="/" asChild>
              <Pressable className="flex-row items-center justify-between bg-slate-950 p-4 rounded-xl border border-slate-800">
                <View className="flex-row items-center">
                  <View className="w-8 h-8 bg-indigo-500/10 rounded-lg items-center justify-center mr-3">
                    <Ionicons name="home-outline" size={18} color="#818cf8" />
                  </View>
        ...
        <View className="bg-slate-900 border border-slate-800 p-5 rounded-2xl gap-3">
